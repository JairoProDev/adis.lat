        ...
        <>
            <style jsx global>{`
                @media print {
                    ...
                    /* Hide everything inside printable-content by default */
                    #printable-content > * { display: none !important; }
                    /* Show only the catalog */
                    #printable-content > .printable-catalog { 
                    ...
                    #printable-content > .printable-catalog * { visibility: visible; }
