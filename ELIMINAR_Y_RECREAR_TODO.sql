-- ============================================
-- ELIMINAR TODO Y RECREAR CON NOMBRES "ADISO"
-- ============================================
-- ⚠️ IMPORTANTE: Este script ELIMINA todas las tablas antiguas y crea nuevas
-- Ejecuta esto en Supabase SQL Editor si quieres empezar completamente limpio
-- Esto eliminará TODOS los datos existentes

-- ============================================
-- PASO 1: ELIMINAR POLÍTICAS Y TABLAS ANTIGUAS
-- ============================================

-- Eliminar políticas de tablas antiguas
...
-- Eliminar políticas del bucket antiguo
...
-- Eliminar tablas (CASCADE elimina índices y constraints automáticamente)
...
-- Eliminar bucket antiguo (esto eliminará TODAS las imágenes)
-- ⚠️ Descomenta la siguiente línea solo si quieres eliminar el bucket antiguo
-- DELETE FROM storage.buckets WHERE id = 'avisos-images';

-- ============================================
-- PASO 2: CREAR TABLA PRINCIPAL "adisos"
-- ============================================
...
CREATE INDEX idx_adisos_categoria ON adisos(categoria);
CREATE INDEX idx_adisos_created_at ON adisos(created_at DESC);
CREATE INDEX idx_adisos_busqueda ON adisos USING GIN (to_tsvector('spanish', titulo || ' ' || descripcion || ' ' || ubicacion));
CREATE INDEX idx_adisos_tamaño ON adisos(tamaño);
...
-- ============================================
-- PASO 3: CREAR TABLA "adisos_gratuitos"
-- ============================================

CREATE TABLE adisos_gratuitos (
  id TEXT PRIMARY KEY,
...
-- Índices
CREATE INDEX idx_adisos_gratuitos_activos 
ON adisos_gratuitos(fecha_expiracion) 
WHERE fecha_expiracion > NOW();

CREATE INDEX idx_adisos_gratuitos_categoria 
...
-- ============================================
-- PASO 4: CREAR BUCKET DE STORAGE "adisos-images"
-- ============================================
