...
import {
    ...
    IconInstagram, IconFacebook, IconTiktok, IconGlobe
                ...
                <div className="max-w-xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    {activeStep === 5 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-8 duration-500">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <label className="block">
                                    <span className="text-xs font-semibold text-slate-600 mb-1.5 block">Pixel de Facebook</span>
                                    <input type="text" className="w-full px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-xs" placeholder="ID (Ej. 123456...)" />
                                </label>
                                <label className="block">
                                    <span className="text-xs font-semibold text-slate-600 mb-1.5 block">Tiktok Pixel</span>
                                    <input type="text" className="w-full px-3 py-2 rounded-lg bg-slate-50 border border-slate-200 text-xs" placeholder="ID (Ej. C123...)" />
                                </label>
                            </div>
                            ...
                            <div className="p-4 rounded-xl border border-amber-200 bg-amber-50">
                                ...
                                <Link href="/publicar" className="text-xs font-bold text-amber-900 underline hover:no-underline">
