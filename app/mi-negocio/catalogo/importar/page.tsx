            ...
            <div className="max-w-5xl mx-auto px-4 py-6 md:py-10">
                ...
                <div className="mb-8">
                    <Link
                        ...
                        className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-blue-600 mb-4 transition-colors"
                    >
                ...
                {/* Tabs */}
                <div className="flex p-1 bg-slate-200 rounded-xl mb-8 w-full md:w-fit">
                    <button
                        onClick={() => { setMode('excel'); setResults(null); }}
                        className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2 ${mode === 'excel'
                    ...
                    <button
                        ...
                        className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2 ${mode === 'manual'
                                ? 'bg-white text-blue-600 shadow-sm'
                                : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
                    ...
                    !results ? (
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 mb-8 animate-in fade-in zoom-in duration-300">
                            <div className="text-center max-w-2xl mx-auto">
                                ...
                                <div
                                    {...getRootProps()}
                                    className={`relative border-3 border-dashed rounded-xl p-10 transition-all cursor-pointer group ${isDragActive
                            ...
                            <div className="p-6 md:p-8">
                                ...
                                <form onSubmit={handleManualSubmit} className="space-y-6">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                        {manualLoading ? (
                                            <>
